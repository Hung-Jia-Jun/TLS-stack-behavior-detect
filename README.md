...
5. 使用 Python requests 庫測試

```
python3 requests_test.py
```

底層為 urllib3 -> ssl module -> OpenSSL，指紋行為與 curl 相同。
預期 Alert 約 4，判定為 OpenSSL 並攔截，連線 timeout。
...
## 檔案結構
    ...
    requests_test.py        Python requests 庫測試（OpenSSL 底層）
